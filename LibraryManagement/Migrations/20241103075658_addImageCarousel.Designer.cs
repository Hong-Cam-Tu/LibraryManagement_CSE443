...
namespace LibraryManagement.Migrations
{
    ...
    [Migration("20241103075658_addImageCarousel")]
    partial class addImageCarousel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagement.Models.Carousel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CarouselId = 1,
                            CreatedDate = new DateTime(2024, 11, 3, 14, 56, 58, 167, DateTimeKind.Local).AddTicks(1815),
                            Description = "Image1",
                            ImageUrl = "/carousel_images/carousel_1.webp",
                            IsActive = true,
                            Order = 1,
                            Title = "Image 1",
                            UpdatedDate = new DateTime(2024, 11, 3, 14, 56, 58, 167, DateTimeKind.Local).AddTicks(1833)
                        },
                        new
                        {
                            CarouselId = 2,
                            CreatedDate = new DateTime(2024, 11, 3, 14, 56, 58, 167, DateTimeKind.Local).AddTicks(1834),
                            Description = "Image2",
                            ImageUrl = "/carousel_images/carousel_2.webp",
                            IsActive = true,
                            Order = 2,
                            Title = "Image 2",
                            UpdatedDate = new DateTime(2024, 11, 3, 14, 56, 58, 167, DateTimeKind.Local).AddTicks(1835)
                        },
                        new
                        {
                            CarouselId = 3,
                            CreatedDate = new DateTime(2024, 11, 3, 14, 56, 58, 167, DateTimeKind.Local).AddTicks(1837),
                            Description = "Image3",
                            ImageUrl = "/carousel_images/carousel_3.webp",
                            IsActive = true,
                            Order = 3,
                            Title = "Image 3",
                            UpdatedDate = new DateTime(2024, 11, 3, 14, 56, 58, 167, DateTimeKind.Local).AddTicks(1837)
                        });
                });
